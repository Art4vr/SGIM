...
//Importación de funciones de perfilUsuario
import { getPerfilUsuario } from '../Controllers/perfilControlador.js';
...
//----------------------- RUTAS DE PERFIL --------------------------
router.get('/perfil/me',authMiddleware, getPerfilUsuario);
